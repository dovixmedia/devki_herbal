...
export default function WhatsAppButton() {
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.9 }}
      className="fixed bottom-6 right-6 z-[100] bg-[#25D366] p-3 rounded-full shadow-lg border-2 border-white flex items-center justify-center transition-shadow hover:shadow-xl"
